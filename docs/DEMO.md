...
**[DEMO_PRESENTATION.md](DEMO_PRESENTATION.md)** (сессия 52, обновлено в
сессии 101 после production-верификации storage/PDF, сессии 92-100); этот файл
...
- **Логотип клиники** — загрузка работает (`/settings`, видно в шапке
  приложения, сессии 81-83/96), но в сгенерированных PDF-документах
  показывается только текст реквизитов клиники, без графического лого.
