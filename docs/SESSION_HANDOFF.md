...
**by AV Systems** · обновлено: 2026-06-19 (после сессии 39: Supplier Reorder Draft from Low Stock v1)
...
11. **Reorder Draft → Send v2**: кнопка "отправлено" прямо с `/inventory/alerts` после
    создания draft (сейчас — переход на страницу заказа и существующий "Mesajı kopyala" /
    markSupplierOrderSent flow).

Завершено в Сессии 39 (Session 40 НЕ начинать в этой сессии).
