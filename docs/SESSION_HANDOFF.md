...
**by AV Systems** · обновлено: 2026-06-15 (после сессии 20: Deployment Readiness / Production Setup)
...
Deployment-readiness закрыт. Варианты по приоритету заказчика:
...
4. S3-совместимый storage (предпосылка для serverless-деплоя) — см.
   DEPLOYMENT.md §1.
