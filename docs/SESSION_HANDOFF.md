...
**by AV Systems** · обновлено: 2026-06-14 (после сессии 15: Patient Communication v1)
...
«Pasiyent məlumat forması» (Tezliklə), **реальная** отправка
...
Patient Communication v1 закрыт. Варианты по приоритету заказчика:
