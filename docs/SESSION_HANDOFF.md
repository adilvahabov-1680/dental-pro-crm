...
**by AV Systems** · обновлено: 2026-06-17 (после сессии 24: Super Admin Clinic & User Management v1)
...
| Admin (кадры/роли клиники, v1+password/login) | готов | `e2e-admin-check` 36/36 |
