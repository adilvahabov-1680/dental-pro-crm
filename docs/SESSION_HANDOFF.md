...
**by AV Systems** · обновлено: 2026-06-18 (после сессии 38: Low Stock Alerts / Reorder Suggestions v1)
...
10. **Low Stock Reorder Workflow v2**: превратить tövsiyə из Сессии 38 в draft
    `SupplierOrder` одним кликом (explicit user action + review step, не auto-create).

Завершено в Сессии 38 (Session 39 НЕ начинать в этой сессии).
