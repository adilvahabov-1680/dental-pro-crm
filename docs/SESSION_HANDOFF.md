...
**by AV Systems** · обновлено: 2026-06-20 (после сессии 42: Appointment Reminder Scheduling Rules v2)
...
| Əlaqə / Patient Communication (v1, manual click-to-chat; + Reminder Scheduling v2, Session 42) | готов | `e2e-communications-check` 40/40, `e2e-appointment-reminder-scheduling-check` 28/28 |
...
14. **Reschedule slot selection (Session 43)**: пациент при `responded_reschedule` пока только
    сообщает «хочу перенести» (без выбора времени) — staff предлагает 2–3 варианта вручную.
    Естественное продолжение Session 41/42.

Завершено в Сессии 42 (Session 43 НЕ начинать в этой сессии).
