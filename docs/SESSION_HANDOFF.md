...
**by AV Systems** · обновлено: 2026-06-22 (после сессии 45: Patient Feedback / Review Flow v1)
...
20. **Fix reschedule_offer bell visibility**: найдено в Session 45 — staff-уведомление
    (`type: "reschedule_offer"`, `channel: "in_app"`) никогда не было добавлено в
    `lib/notifications.ts:TYPE_PERMISSION`, поэтому невидимо в bell/`/notifications` с Session 43.
    Маленький, изолированный фикс — добавить одну строку в карту.
...
Завершено в Сессии 45 (Session 46 НЕ начинать в этой сессии).
