...
**by AV Systems** · обновлено: 2026-06-16 (после сессии 21: Free Public Demo Deploy Preparation)
...
Free demo-деплой (Vercel + Neon) готов к запуску. Варианты по приоритету:
